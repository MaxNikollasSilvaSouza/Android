...
public class dificil extends AppCompatActivity implements OnGameListener {


    MyView[] cartas;
    int [] desenhos = {R.drawable.d10,R.drawable.d9,R.drawable.d8,R.drawable.d6,R.drawable.d7};
    int pnts = 0;
    TextView placar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cartas[2]=(MyView)findViewById(R.id.imageView3);
        cartas[3]=(MyView)findViewById(R.id.imageView4);
        cartas[4]=(MyView)findViewById(R.id.imageView5);
        cartas[5]=(MyView)findViewById(R.id.imageView6);
        cartas[6]=(MyView)findViewById(R.id.imageView7);
        cartas[7]=(MyView)findViewById(R.id.imageView8);
        cartas[8]=(MyView)findViewById(R.id.imageView9);
        cartas[9]=(MyView)findViewById(R.id.imageView10);
